...
struct SelectSqlNode
{
  ...
  // std::vector<std::string>                 relations;    ///< 查询的表, not support inner join
  std::vector<std::vector<std::pair<std::string, std::vector<ConditionSqlNode> > > > relations;    ///< 查询的表
...
struct InsertSqlNode
{
  ...
  std::vector<std::vector<Value>> items;         ///< 要插入的条目
};
